import { AlertCircle, FileText, FlaskConical, FolderOpenDot, Microscope, ScanLine, Stethoscope } from 'lucide-react';
    ...
    <div className="space-y-3">
      {error && (
        <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800">
          ...
          <div>
            <p className="font-medium">Module metadata unavailable</p>
